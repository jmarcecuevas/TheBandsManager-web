...
%{--<head>--}%
    ...
    %{--<!-- Gritter -->--}%
    %{--<asset:stylesheet src="/plugins/gritter/jquery.gritter.css" />--}%
            ...
            %{--<ul class="nav metismenu" id="side-menu">--}%
                %{--<li class="nav-header">--}%
                    ...
                    %{--</span>--}%
                        %{--<a data-toggle="dropdown" class="dropdown-toggle" href="#">--}%
                            %{--<span class="clear">--}%
                                %{--<span class="block m-t-xs"> <strong class="font-bold"><sec:username/></strong> </span>--}%

                                %{--<sec:ifAllGranted roles="ROLE_ADMIN">--}%
                                    %{--<span class="text-muted text-xs block">ROL Admin<b class="caret"></b> </span>--}%
                                %{--</sec:ifAllGranted>--}%

                                %{--<span class="text-muted text-xs block">ROL User<b class="caret"></b> </span>--}%
                ...
                %{--<li>--}%
                    ...
                    %{--<ul class="nav nav-second-level collapse">--}%
                        %{--<li> (<g:link controller="instrument">Crear</g:link> </li>--}%
                        %{--<li><a href="form_basic">Crear</a></li>--}%
                        %{--<li><a href="form_advanced">Editar</a></li>--}%
                        %{--<li><a href="form_wizard">Eliminar</a></li>--}%
                    %{--</ul>--}%
                %{--</li>--}%
                ...
                %{--<li>--}%
                    %{--<a href="widgets"><i class="fa fa-search"></i> <span class="nav-label">Búsqueda</span></a>--}%
                %{--</li>--}%

                %{--<li>--}%
                    %{--<a href="widgets"><i class="fa fa-sign-out"></i> <span class="nav-label">Logout</span></a>--}%
                %{--</li>--}%
        ...
        %{--<div class="row border-bottom">--}%
            %{--<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">--}%
                ...
                %{--<ul class="nav navbar-top-links navbar-right">--}%
                    %{--<li>--}%
                        %{--<span class="m-r-sm text-muted welcome-message">Welcome to TBM TheBandsManager.</span>--}%
                    %{--</li>--}%
                    %{--<li class="dropdown">--}%
                                ...
                                %{--<div class="ibox-content">--}%
                                    ...
                                    %{--<div>--}%
                                        %{--<div class="feed-activity-list">--}%
                                            ...
                                            %{--<div class="feed-element">--}%
                                                %{--<a href="profile" class="pull-left">--}%
                                                    %{--<g:img alt="image" class="img-circle" src="/a5.jpg" />--}%
                                                %{--</a>--}%
                                                %{--<div class="media-body ">--}%
                                                    %{--<small class="pull-right">2h ago</small>--}%
    ...
    %{--$(document).ready(function() {--}%
        %{--setTimeout(function() {--}%
            %{--toastr.options = {--}%
                ...
                %{--timeOut: 4000--}%
            %{--};--}%
            %{--toastr.success('TheBandsManager', 'Welcome to TBM');--}%
